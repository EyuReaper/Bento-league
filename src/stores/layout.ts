...
export const useLayoutStore = defineStore('layout', {
  state: () => ({
    widgets: [
      { id: 'potw', component: 'PlayerOfTheWeek',      gridArea: 'span 4 / span 3',  order: 1 },
      ...
      { id: 'll',   component: 'LeagueLogo',           gridArea: 'span 2 / span 3',  order: 8 },
      { id: 'hc',   component: 'H2HComparison',        gridArea: 'span 4 / span 3',  order: 9 },
      { id: 'gsv',  component: 'GraphicalSeasonView',  gridArea: 'span 3 / span 6',  order: 10 },
